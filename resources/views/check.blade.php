...
@include('layouts.app')
  ...
  <button id="sbm" class='btn btn-primary'> Submit </button>
  <br /> <br />
  <div id="editing">
...
channel.bind('new-message',function(message){
  console.log('checking message 1');
  console.log(message);
  console.log('checking message 2');
  ...
  getMessageContents.forEach(function(eachMessageContent){
    ...
    console.log(eachMessageContent.created_at);
